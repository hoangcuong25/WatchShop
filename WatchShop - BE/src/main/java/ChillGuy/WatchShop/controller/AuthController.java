...
public class AuthController {
    ...
    public ResponseEntity<ResLoginDTO> login(@Valid @RequestBody ReqLoginDTO loginDto) {
        ...
        // set cookie chỉ cho refresh_token
    ...
    public ResponseEntity<String> getRoleFromToken(
            @CookieValue(name = "refresh_token", defaultValue = "") String refreshToken) throws ThrowBadReqException {

        if (refreshToken.isEmpty()) {
            throw new ThrowBadReqException("Không tìm thấy refresh token");
        }
        ...
        try {
            ...
            throw new ThrowBadReqException("Refresh token không hợp lệ");
        }
    }
}
